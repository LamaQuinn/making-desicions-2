...
//Code Here
let someNum = []
for(i=0; i<myFavoriteNumbers.length-1; i++){
  
  someNum.push(myFavoriteNumbers[i])
...
//           console.log("There is not enough elemts in the array.")
//          }
//          if (myFavoriteNumbers.length>=7){
//   someNum.push(myFavoriteNumbers[6])
  
//          }
         
// }
//console.log(someNum[6])
//console.log(someNum.length)
////////// PROBLEM 8 //////////
...
for (let i = 0; i<listOfNumbers.length; i++){
  if (listOfNumbers[i]%3==0){
    console.log (`${listOfNumbers[i]} is divided by 3.`)
  }
}
